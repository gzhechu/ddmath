...
# manimgl ex20200510_rolling_circle_gl.py RollingCircle1 -r 1280x720 -m -w
# manimgl ex20200510_rolling_circle_gl.py RollingCircle2 -r 1280x720 -m -w
...
class RollingCircle2(Scene):
    ...
    def construct(self):
        ...
        t1 = Tex("r_1:r_2=3:1").scale(1.5)
        t1.shift(UP*self.r2*2+RIGHT*(self.r2-1))

        t2 = Tex("r_3=r_1-r_2").scale(1.5)
        t2.next_to(t1, DOWN, buff=0.5)

        tx3 = Tex("r_3:r_2=2:1").scale(1.5)
        ...
        def update2(group, alpha):
            ...
            # agc = "0"
            # print(agr)
            ta = Tex("angle={:d}".format(
                agr), alignment="\\raggedright").scale(1.5)
            tb = Tex("round={:s}".format(
        ...
        ta = Tex("angle=0", alignment="\\raggedright").scale(1.5)
        tb = Tex("round=0", alignment="\\raggedright").scale(1.5)
        ...
        rnd = Tex("round").scale(2)
        rnd.next_to(equl, LEFT)
        t2 = Tex("s=2\\times\\pi\\times r_3").scale(2)
        t2.move_to(UP*(self.txt+1))
        t3 = Tex("c=2\\times\\pi\\times r_2").scale(2)
        t3.move_to(UP*(self.txt-1))
        t4r = Tex("\\frac{s}{c}").scale(2)
...
class Test(Scene):
    ...
    def construct(self):
        ...
        t2 = Tex("\\bigodot_1   r_1").scale(1.5)
        t2.move_to(UP*(self.txt))

        t3 = Tex("\\bigcirc_2   r_2").scale(1.5)
